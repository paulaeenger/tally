// Target path: app/(app)/budgets/loading.tsx (NEW FILE)
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-start justify-between">
        <div className="space-y-2">
          ...
          <div className="h-9 w-28 animate-pulse rounded bg-subtle" />
          <div className="h-4 w-52 animate-pulse rounded bg-subtle" />
        </div>
